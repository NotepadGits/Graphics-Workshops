...
public:
	...
	*/
	Lives() {
		...
		tex3.load("..//..//Assets//Textures//Lives3.png");
		tex2.load("..//..//Assets//Textures//Lives2.png");
		tex1.load("..//..//Assets//Textures//Lives1.png");
	...
	void render()
	{
		...
		if (LivesRemaining == 2) { glBindTexture(GL_TEXTURE_2D, tex2.texture); }
		if (LivesRemaining == 1) { glBindTexture(GL_TEXTURE_2D, tex1.texture); }
