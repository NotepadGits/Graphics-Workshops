...
int main(int argc, char *argv[]) {
	...
	//create shaders
	Shader trivSH("..//..//Assets//Shaders//shader.vert");
	Shader trifSH("..//..//Assets//Shaders//shader.frag");
	...
	glAttachShader(shaderProgram2, trivSH.shaderID);
	glAttachShader(shaderProgram2, trifSH.shaderID);
	glLinkProgram(shaderProgram2);

	//delete shader source code pointers
	glDeleteShader(trivSH.shaderID);
	glDeleteShader(trifSH.shaderID);


	////set triangle buffer ()three triangles
	//for (int tR = 0; tR < 3; tR++)
	//{
	//	triangle[tR].setBuffers();
	//}
	//
	//***********************************************
